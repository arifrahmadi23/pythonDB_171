...
def hasil_prediksi():
    ...
    connection = sqlite3.connect("PrediksiFakultas10.db")
    ...
    cursor.execute("INSERT INTO nilai_siswa (nama_siswa, biologi, fisika,kimia, matematika, inggris, bindonesia, geografi, ekonomi, sosiologi, pkn, prediksi_fakultas) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                   (nama_siswa, biologi, fisika, kimia, matematika, inggris, bindonesia, geografi, ekonomi, sosiologi, pkn, prediksi_fakultas))
